...
@WebServlet("/GetAllShelf")
public class GetAllShelf extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Map<String, Object> map = new ShelfDao().getAllShelfs(page);
			if (map == null) {
				...
				jsonObject.setData(map);// 返回书架和总页数信息
			}
		} catch (Exception e) {
			jsonObject.setStatus(0);
